...
<body>
	...
	<div id = "sidebar">
			<ul id = "menu" class = "nav menu">
				...
				<li><li><a href = "patient.php"><i class = "glyphicon glyphicon-user"></i> Patient's List</a></li></li>
				</li>
			</ul>
	</div>
	<div id = "content">
		...
		<div class = "panel panel-success">	
			<div class = "panel-heading">
				<label>Patient's Info / EDIT</label>
			...
			<?php
				$conn = new mysqli("localhost", "root", "", "hcpms") or die(mysqli_error());
				$q = $conn->query("SELECT * FROM `patient` WHERE `patient_no` = '$_GET[id]' && `lastname` = '$_GET[lastname]'") or die(mysqli_error());
				$f = $q->fetch_array();
			?>
	...
	<div id = "footer">
		<label class = "footer-title">&copy;Treneyan IT Sol</label>
	</div>
