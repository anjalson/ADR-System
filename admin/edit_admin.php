				...
				<form id = "form_admin" method = "POST" enctype = "multi-part/form-data" >
					...
					<div class = "panel-body">
						...
						<div class = "form-group">
							...
							<input class = "form-control" type = "text" name = "fname" value = "<?php echo $fetch['fname'] ?>" required = "required">
						</div>
						<div class = "form-group">
							<label for = "secondname">Second Name: </label>
							<input class = "form-control" type = "text" name = "sname" value = "<?php echo $fetch['sname'] ?>">
						</div>
						<div class = "form-group">
